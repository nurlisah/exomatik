...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2018 at 10:26 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='tabel anggota dimana semua nggota yang terdaftar memiliki akun secara langsung' AUTO_INCREMENT=3 ;
...
(2, '2120410013', 'Nurlisah', '1999-04-06', 'perempuan', '085241746695', 10, 'anggota', 'anggota_20180327093138', 'Nusa', 0, 'one@exomatik.com', 'dfb9e85bc0da607ff76e0559c62537e8', 'blokir');
...
CREATE TABLE IF NOT EXISTS `table_pendaftaran` (
  ...
  `citacita` varchar(30) NOT NULL,
  `hobi` varchar(40) NOT NULL,
  `no_hp` varchar(50) NOT NULL,
  `email` varchar(40) NOT NULL,
  `foto_profil` varchar(100) NOT NULL,
  `po` varchar(1000) NOT NULL,
...
INSERT INTO `table_pendaftaran` (`id_pendaftaran`, `nama_lengkap`, `nama_panggilan`, `jk`, `tempat_lahir`, `tanggal_lahir`, `agama`, `alamat`, `jurusan`, `angkatan`, `citacita`, `hobi`, `no_hp`, `email`, `foto_profil`, `po`, `alasan`) VALUES
(6, 'Nurlisa', 'Lisha', 'perempuan', 'Nusa', '1999-06-04', 'Islman', 'Desa Nusa Kecamatan Kahu Kabupaten Bone', 'Sistem Informasi', '2015', 'Programer', 'main Volly', '085241746695', 'nurlisah46@gmail.com', 'anggota_20180327092921.jpg', 'gjdhskadhksjadlksjdnaksdgkjdnkj ndjhndbj jhbjhdnmb bjh', 'hduhjadghj hgdujhabdjhasgdv hgjgdjhsa');
