                 ...
                 $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i=0;i<Jpendaftar.length;++i){
                            $('#pendaftaranLoop').append('<tr><td>'+(i+1)+'</td><td>'+Jpendaftar[i].nama_lengkap+'</td><td>'+Jpendaftar[i].nama_panggilan+'</td><td>'+Jpendaftar[i].jk+'</td><td>'+Jpendaftar[i].angkatan+'</td><td>'+Jpendaftar[i].jurusan+'</td><td>'+Jpendaftar[i].foto_profil+'</td><td><button class="btn btn-danger btn-rounded" onclick="deleteData('+Jpendaftar[i].id_pendaftaran+')">Hapus</button><a href="<?=base_url()?>admin/print/pdf/'+Jpendaftar[i].id_pendaftaran+'" class="btn btn-primary btn-rounded">Cetak</a></td></tr>');
                        }
                    }
                });
            }
